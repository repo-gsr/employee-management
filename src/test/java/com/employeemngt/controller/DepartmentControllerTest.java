...
public class DepartmentControllerTest {
	...
	public void createEmployeeTest() {
		...
		ResponseEntity<Department> actualResult = departmentcontroller.create(department);
	...
	public void updateDepartmentByIDTest() {
		...
		ResponseEntity<Department> actualResult = departmentcontroller.updateDepartmentByID(department,
				department.getId());
